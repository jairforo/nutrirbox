 ...
 */
class Disciplina extends \Corporativo\ConcurseiroBundle\Entity\Disciplina implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Corporativo\\ConcurseiroBundle\\Entity\\Disciplina' . "\0" . 'coDisciplina', '' . "\0" . 'Corporativo\\ConcurseiroBundle\\Entity\\Disciplina' . "\0" . 'noNome', '' . "\0" . 'Corporativo\\ConcurseiroBundle\\Entity\\Disciplina' . "\0" . 'deDescricao', '' . "\0" . 'Corporativo\\ConcurseiroBundle\\Entity\\Disciplina' . "\0" . 'noCor'];
        }
    ...
    public function getCoDisciplina()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getCoDisciplina();
        }
