 ...
 */
class StatusTransacao extends \Corporativo\ConcurseiroBundle\Entity\StatusTransacao implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Corporativo\\ConcurseiroBundle\\Entity\\StatusTransacao' . "\0" . 'coStatusTransacao', '' . "\0" . 'Corporativo\\ConcurseiroBundle\\Entity\\StatusTransacao' . "\0" . 'noNome', '' . "\0" . 'Corporativo\\ConcurseiroBundle\\Entity\\StatusTransacao' . "\0" . 'deDescricao'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StatusTransacao $proxy) {
    ...
    public function getCoStatusTransacao()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getCoStatusTransacao();
        }
