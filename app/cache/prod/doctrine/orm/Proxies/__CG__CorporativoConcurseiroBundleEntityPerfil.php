 ...
 */
class Perfil extends \Corporativo\ConcurseiroBundle\Entity\Perfil implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Corporativo\\ConcurseiroBundle\\Entity\\Perfil' . "\0" . 'coPerfil', '' . "\0" . 'Corporativo\\ConcurseiroBundle\\Entity\\Perfil' . "\0" . 'noNome', '' . "\0" . 'Corporativo\\ConcurseiroBundle\\Entity\\Perfil' . "\0" . 'isAtivo'];
        }
