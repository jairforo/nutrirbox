 ...
 */
class Nivel extends \Corporativo\ConcurseiroBundle\Entity\Nivel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Corporativo\\ConcurseiroBundle\\Entity\\Nivel' . "\0" . 'coNivel', '' . "\0" . 'Corporativo\\ConcurseiroBundle\\Entity\\Nivel' . "\0" . 'noNome', '' . "\0" . 'Corporativo\\ConcurseiroBundle\\Entity\\Nivel' . "\0" . 'deDescricao'];
        }
