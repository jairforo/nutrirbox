...
namespace Proxies\__CG__\Corporativo\NutrirBoxBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Perfil extends \Corporativo\NutrirBoxBundle\Entity\Perfil implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Corporativo\\NutrirBoxBundle\\Entity\\Perfil' . "\0" . 'coPerfil', '' . "\0" . 'Corporativo\\NutrirBoxBundle\\Entity\\Perfil' . "\0" . 'noNome', '' . "\0" . 'Corporativo\\NutrirBoxBundle\\Entity\\Perfil' . "\0" . 'isAtivo'];
        }
